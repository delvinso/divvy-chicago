...
# Census Tracts & Community AreaMap Projection and Transformation  ----
      ...
      proj4string(areas) <- CRS("+proj=longlat +datum=WGS84 +no_defs +nadgrids=@null")
      areas <- spTransform(areas, CRS("+proj=utm +zone=33 +ellps=WGS84 +datum=WGS84 +units=m +no_defs") )
